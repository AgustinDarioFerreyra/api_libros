...
// Obtener todos los libros ( funciona bien )
...
// Obtener un libro por ID ( funciona bien )
...
// Crear un nuevo libro ( funciona pero al id lo almacena como null )
...
// Actualizar un libro existente ( funciona bien )
router.put("/:id", (req, res, next) => {
    try {
        ...
        libro.titulo = titulo || libro.titulo; // No entiendo porque se agrega || libro.titulo
...
// Eliminar un libro ( funciona bien )
